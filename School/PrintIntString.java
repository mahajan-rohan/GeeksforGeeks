/*
Java Input/Output
Given a string S and an integer number N, print the output in the form: 
"The input string :S" and "The input integer :N" in the two separate lines.
...
printIntString() which takes the String S and an Integer N as input 
parameters and print two Strings on separate lines as mentioned above.
