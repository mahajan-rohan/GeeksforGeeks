...
Your task is to create a method named print (which takes one integer as input ) in class Child which 
overrides the method print of the Parent class such that its prints the square of the input integer. 
In Main function instance of both classes are made and all methods are called in the editor.

Input:
The first line of input contains an integer T denoting the no of test cases then T test cases follow. 
First line of each test case contains four integers p,q,r,s.
