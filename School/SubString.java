...
Your Task:  
You dont need to read input or print anything. Complete the function javaSub() 
which takes S, L, R as input parameter and returns the sting from the range L to R.
