...
maximum element would be removed, while in the second step minimum element of the remaining 
array would be removed, in the third step again the maximum and so on. Continue this till the 
...
leftElement() which takes the array A[] and its size N as inputs and returns the final 
